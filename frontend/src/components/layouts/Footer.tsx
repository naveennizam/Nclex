    ...
    return (
        ...
        <section className="footer-section">
            <div className="container overflow-hidden">
                <div className="row gy-4 gy-lg-0 justify-content-xl-between">
                    ...
                    <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                        <div className="widget">
                            <a href="#!">
                                <img src="/images/apple-icon.png" alt="NCLEX Logo" width="175" height="57" />
                            </a>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                        <div className="widget">
                            ...
                            <address>8014 Edith Blvd NE, Albuquerque, New York, United States</address>
                            <p>
                                <a href="tel:+15057922430">(505) 792-2430</a>
                            </p>
                            <p>
                                <a href="mailto:demo@yourdomain.com">demo@yourdomain.com</a>
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="col-12 col-md-4 col-lg-3 col-xl-2">
                        <div className="widget">
                            <h4 className="widget-title">Learn More</h4>
                ...
                <div className="row gy-4 gy-md-0 align-items-md-center py-2">
                    ...
                    {/* Social Icons */}
                    <div className="col-xs-12 col-md-5 order-0 order-md-1 py-4">
