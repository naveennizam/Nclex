...
const Footer = () => {
    ...
    return (
        ...
        <section className="footer label bg-dark" >
                                        ...
                                        <div className="row gy-4">
                                            <div className="col-12">
                                                <div className="input-group">
                                                    ...
                                                    {/* value=""  */}
                                                    <input type="email" className="form-control" id="email-newsletter" placeholder="Email Address" aria-label="email-newsletter" aria-describedby="email-newsletter-addon" required/>
                                                </div>
                                            </div>
                                            <div className="col-12">
